...
Public Class rptMFEPSiswa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penunjang_deti.rptMFEPSiswa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMFEPSiswa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMFEPSiswa = New rptMFEPSiswa()
        rpt.Site = Me.Site
        Return rpt
    End Function
